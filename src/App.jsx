...
const LogoSVG = () => (
  <svg width="100%" height="100%" viewBox="0 0 680 170" xmlns="http://www.w3.org/2000/svg" style={{display:"block"}}>
    ...
    <rect x="303" y="62" width="3" height="68" fill="#5a1010"/>
    <rect x="325" y="72" width="15" height="58" rx="2" fill="#1a4a2a"/>
    <rect x="325" y="72" width="3" height="58" fill="#123520"/>
    <rect x="344" y="56" width="19" height="74" rx="2" fill="#2a3a5a"/>
    <rect x="344" y="56" width="3" height="74" fill="#1a2a4a"/>
    <rect x="367" y="66" width="16" height="64" rx="2" fill="#6a5020"/>
    <rect x="367" y="66" width="3" height="64" fill="#4a3810"/>
    <rect x="387" y="52" width="18" height="78" rx="2" fill="#4a2a5a"/>
    <rect x="387" y="52" width="3" height="78" fill="#331a40"/>
    <rect x="409" y="68" width="14" height="62" rx="2" fill="#3a3a4a"/>
    <rect x="409" y="68" width="3" height="62" fill="#2a2a3a"/>
    <rect x="427" y="58" width="17" height="72" rx="2" fill="#6a3010"/>
    <rect x="427" y="58" width="3" height="72" fill="#4a2008"/>
    <rect x="448" y="70" width="15" height="60" rx="2" fill="#3a4a1a"/>
    <rect x="448" y="70" width="3" height="60" fill="#283410"/>
    <rect x="467" y="62" width="16" height="68" rx="2" fill="#5a2a1a"/>
